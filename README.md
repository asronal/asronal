...
### Electronics & Communication Engineering | VLSI | Embedded Systems

ECE student focused on **VLSI / RTL design and embedded systems**, with hands-on work across digital design, RISC-V architecture, ASIC synthesis, edge AI, Raspberry Pi and hardware-integrated systems.

I am primarily looking for **VLSI, RTL/ASIC, FPGA and Embedded Systems internships and entry-level opportunities**.
...
- RISC-V processors
- DSP and AI hardware acceleration
- Edge AI / TinyML
- Embedded Linux
...
![Synopsys](https://img.shields.io/badge/Synopsys-000000?style=for-the-badge)
